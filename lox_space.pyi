...
class Angle:
    ...
    Format in the display unit with `f"{angle:.2f}"` (returns degrees).
    """
    ...
    def from_degrees(cls, value: float) -> Angle:
        ...
        ...
    @classmethod
    def from_arcseconds(cls, value: float) -> Angle:
    ...
    def __round__(self, ndigits: int | None = None) -> Angle: ...
...
class AngularRate:
    ...
    Convert to float with `float(rate)` (returns radians per second).
    Format in the display unit with `f"{rate:.2f}"` (returns deg/s).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_radians_per_second(cls, value: float) -> AngularRate:
        """Creates an `AngularRate` from a value in radians per second."""
        ...
    @classmethod
    def from_degrees_per_second(cls, value: float) -> AngularRate:
        """Creates an `AngularRate` from a value in degrees per second."""
        ...
    ...
    def __abs__(self) -> AngularRate: ...
    def __mul__(self, other: float) -> AngularRate: ...
    def __rmul__(self, other: float) -> AngularRate: ...
    @overload
    def __truediv__(self, other: AngularRate) -> float: ...
    @overload
    def __truediv__(self, other: float) -> AngularRate: ...
    def __round__(self, ndigits: int | None = None) -> AngularRate: ...
    def __eq__(self, other: object) -> bool: ...
    def __lt__(self, other: AngularRate) -> bool: ...
    def __le__(self, other: AngularRate) -> bool: ...
    def __gt__(self, other: AngularRate) -> bool: ...
    def __ge__(self, other: AngularRate) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __format__(self, format_spec: str, /) -> str: ...
...
class Distance:
    ...
    Format in the display unit with `f"{distance:.2f}"` (returns kilometers).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_meters(cls, value: float) -> Distance:
        ...
        ...
    @classmethod
    def from_kilometers(cls, value: float) -> Distance:
        """Creates a `Distance` from a value in kilometers."""
        ...
    @classmethod
    def from_astronomical_units(cls, value: float) -> Distance:
    ...
    def __round__(self, ndigits: int | None = None) -> Distance: ...
    def __eq__(self, other: object) -> bool: ...
...
class Frequency:
    ...
    Convert to float with `float(frequency)` (returns hertz).
    Format in the display unit with `f"{frequency:.2f}"` (returns GHz).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_hertz(cls, value: float) -> Frequency:
        """Creates a `Frequency` from a value in hertz."""
        ...
    @classmethod
    def from_kilohertz(cls, value: float) -> Frequency:
        """Creates a `Frequency` from a value in kilohertz."""
        ...
    @classmethod
    def from_megahertz(cls, value: float) -> Frequency:
        """Creates a `Frequency` from a value in megahertz."""
        ...
    @classmethod
    def from_gigahertz(cls, value: float) -> Frequency:
        """Creates a `Frequency` from a value in gigahertz."""
        ...
    @classmethod
    def from_terahertz(cls, value: float) -> Frequency:
        """Creates a `Frequency` from a value in terahertz."""
        ...
    ...
    def __round__(self, ndigits: int | None = None) -> Frequency: ...
    def __eq__(self, other: object) -> bool: ...
...
class GravitationalParameter:
    ...
    Convert to float with `float(mu)` (returns m³/s²).
    Format in the display unit with `f"{mu:.2f}"` (returns km³/s²).
    ...
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_m3_per_s2(cls, value: float) -> GravitationalParameter:
    ...
    def to_km3_per_s2(self) -> float:
        ...
        ...
    def __abs__(self) -> GravitationalParameter: ...
    def __round__(self, ndigits: int | None = None) -> GravitationalParameter: ...
    def __eq__(self, other: object) -> bool: ...
    def __lt__(self, other: GravitationalParameter) -> bool: ...
    def __le__(self, other: GravitationalParameter) -> bool: ...
    def __gt__(self, other: GravitationalParameter) -> bool: ...
    def __ge__(self, other: GravitationalParameter) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __format__(self, format_spec: str, /) -> str: ...
...
class Power:
    ...
    Format in the display unit with `f"{power:.2f}"` (returns W).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_watts(cls, value: float) -> Power:
        ...
        ...
    @classmethod
    def from_kilowatts(cls, value: float) -> Power:
    ...
    @overload
    def __truediv__(self, other: Power) -> float: ...
    @overload
    def __truediv__(self, other: float) -> Power: ...
    def __round__(self, ndigits: int | None = None) -> Power: ...
    def __eq__(self, other: object) -> bool: ...
...
class Temperature:
    ...
    Convert to float with `float(temperature)` (returns Kelvin).
    Format in the display unit with `f"{temperature:.2f}"` (returns K).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    ...
    @overload
    def __truediv__(self, other: Temperature) -> float: ...
    @overload
    def __truediv__(self, other: float) -> Temperature: ...
    def __round__(self, ndigits: int | None = None) -> Temperature: ...
    def __eq__(self, other: object) -> bool: ...
...
class Pressure:
    ...
    Use with unit constants: `1013.25 * lox.hPa` or `101325 * lox.Pa`
    Convert to float with `float(pressure)` (returns pascals).
    Format in the display unit with `f"{pressure:.2f}"` (returns Pa).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_pa(cls, value: float) -> Pressure:
        """Creates a `Pressure` from a value in pascals."""
        ...
    @classmethod
    def from_hpa(cls, value: float) -> Pressure:
        """Creates a `Pressure` from a value in hectopascals."""
        ...
    ...
    def __round__(self, ndigits: int | None = None) -> Pressure: ...
    def __eq__(self, other: object) -> bool: ...
...
class Velocity:
    """Velocity type for type-safe velocity values.

    Use with unit constants: `7.8 * lox.km_per_s` or `100 * lox.m_per_s`
    Convert to float with `float(velocity)` (returns meters per second).
    Format in the display unit with `f"{velocity:.2f}"` (returns km/s).
    """
    def __new__(cls, value: float) -> Self: ...
    @classmethod
    def from_meters_per_second(cls, value: float) -> Velocity:
        """Creates a `Velocity` from a value in meters per second."""
        ...
    @classmethod
    def from_kilometers_per_second(cls, value: float) -> Velocity:
        """Creates a `Velocity` from a value in kilometers per second."""
        ...
    ...
    def __round__(self, ndigits: int | None = None) -> Velocity: ...
    def __eq__(self, other: object) -> bool: ...
...
class Decibel:
    ...
    Use with the unit constant: `26.6 * lox.dB`
    Convert to float with `float(value)` (returns dB).
    Format with `f"{value:.2f}"` (returns dB).
    ...
    def __abs__(self) -> Decibel: ...
    def __mul__(self, other: float) -> Decibel: ...
    def __rmul__(self, other: float) -> Decibel: ...
    @overload
    def __truediv__(self, other: Decibel) -> float: ...
    @overload
    def __truediv__(self, other: float) -> Decibel: ...
    def __round__(self, ndigits: int | None = None) -> Decibel: ...
    def __eq__(self, other: object) -> bool: ...
    def __lt__(self, other: Decibel) -> bool: ...
    def __le__(self, other: Decibel) -> bool: ...
    def __gt__(self, other: Decibel) -> bool: ...
    def __ge__(self, other: Decibel) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __format__(self, format_spec: str, /) -> str: ...
...
class TimeDeltaUnit:
    ...
    `duration / lox.minutes` is that duration in minutes as a plain `float`.

    Units: `seconds`, `minutes`, `hours`, `days`.

    Args:
        symbol: The unit name, e.g. `"minutes"`.
    """
    def __new__(cls, symbol: str) -> Self: ...
    @property
    def symbol(self) -> str:
...
seconds: TimeDeltaUnit
"""1 second"""
minutes: TimeDeltaUnit
"""60 seconds"""
hours: TimeDeltaUnit
"""3600 seconds"""
days: TimeDeltaUnit
...
class GroundStation:
    ...
    def tx_terminals(self) -> dict[str, TxTerminal]:
        ...
        ...
    def rx_terminals(self) -> dict[str, RxTerminal]:
...
class TimeDelta:
    ...
    @overload
    def __truediv__(self, other: TimeDeltaUnit) -> float: ...
    @overload
...
class NoiseTempReceiver:
    ...
    setup from the chain's antenna noise temperature and feed loss. For a
    ...
    """
    def __new__(cls, noise_temperature: Temperature) -> Self: ...
    @property
...
class TxChain:
    ...
    def band(self) -> FrequencyRange:
        ...
        ...
    @property
    def antenna(self) -> ConstantAntenna | PatternedAntenna:
        """The antenna radiating this chain."""
        ...
    @property
    def transmitter(self) -> AmplifierTransmitter:
        """The transmitter driving this chain."""
        ...
    @property
    def feed_loss(self) -> Decibel:
...
class RxChain:
    ...
    def antenna(self) -> ConstantAntenna | PatternedAntenna:
        ...
        ...
    @property
    def receiver(self) -> NoiseTempReceiver | CascadeReceiver:
    ...
    def feed_loss(self) -> Decibel:
        ...
        ...
    @property
    def antenna_noise_temperature(self) -> Temperature:
...
class EirpModel:
    ...
    """
    def __new__(cls, band: FrequencyRange | str, eirp: Decibel) -> Self: ...
    @property
    def band(self) -> FrequencyRange:
...
class GtModel:
    ...
    """
    def __new__(cls, band: FrequencyRange | str, gt: Decibel) -> Self: ...
    @property
    def band(self) -> FrequencyRange:
        """Frequency range over which the figure applies."""
        ...
