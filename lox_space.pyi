...
class AntennaId:
    """Identifier of an antenna in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class TransmitterId:
    """Identifier of a transmitter in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class ReceiverId:
    """Identifier of a receiver in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class EirpModelId:
    """Identifier of a lumped EIRP model in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class GtModelId:
    """Identifier of a lumped G/T model in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class TxPortId:
    """Identifier of a transmit port in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class RxPortId:
    """Identifier of a receive port in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...

class TerminalId:
    """Identifier of a terminal in a CommsPayload. Only valid for the payload that minted it; other payloads reject it."""
    def __eq__(self, other: object) -> bool: ...
    def __repr__(self) -> str: ...
