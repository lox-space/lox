...
/// contributions as [`EnvironmentalLosses`].
///
/// This is the main entry point, combining rain (P.618), gaseous (P.676),
/// cloud (P.840), and scintillation (P.618) attenuation.
///
/// # Arguments
///
/// * `lat` — Latitude
...
/// # Returns
///
/// [`EnvironmentalLosses`] with rain, gaseous, cloud, and scintillation fields populated.
/// The `atmospheric` field contains the ITU-R combined total:
/// A = A_g + √((A_r + A_c)² + A_s²)
