...
mod tests {
    ...
    #[test]
    fn test_right_ascension_coefficients_9511010() {
        assert_eq!([9.47f64, 0f64, 0f64], Gaspra::RIGHT_ASCENSION_COEFFICIENTS)
    }
    #[test]
    fn test_declination_coefficients_9511010() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2431010() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2000001() {
        assert_eq!(
    ...
    #[test]
    fn test_declination_coefficients_2000001() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2000002() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2000004() {
        assert_eq!(
    ...
    #[test]
    fn test_right_ascension_coefficients_2000021() {
        assert_eq!([52f64, 0f64, 0f64], Lutetia::RIGHT_ASCENSION_COEFFICIENTS)
    }
    #[test]
    fn test_declination_coefficients_2000021() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2000433() {
        assert_eq!([11.35f64, 0f64, 0f64], Eros::RIGHT_ASCENSION_COEFFICIENTS)
    }
    #[test]
    fn test_declination_coefficients_2000433() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2000511() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2002867() {
    ...
    #[test]
    fn test_right_ascension_coefficients_2025143() {
        assert_eq!(
            [90.53f64, 0f64, 0f64],
