...
use super::{
    Ellipsoid, NaifId, PointMass, PolynomialCoefficient, RightAscensionCoefficients,
...
impl RotationalElements for Mercury {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(281.0103f64),
        PolynomialCoefficient(-0.0328f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Venus;
...
impl RotationalElements for Venus {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(272.76f64),
        PolynomialCoefficient(0f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Earth;
...
impl RotationalElements for Earth {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(0f64),
        PolynomialCoefficient(-0.641f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Mars;
...
impl RotationalElements for Mars {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(317.269202f64),
        PolynomialCoefficient(-0.10927547f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Jupiter;
...
impl RotationalElements for Jupiter {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(268.056595f64),
        PolynomialCoefficient(-0.006499f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Saturn;
...
impl RotationalElements for Saturn {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(40.589f64),
        PolynomialCoefficient(-0.036f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub struct Uranus;
...
impl RotationalElements for Uranus {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(257.311f64),
        PolynomialCoefficient(0f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
...
impl RotationalElements for Neptune {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(299.36f64),
        PolynomialCoefficient(0f64),
    );
}
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
...
impl RotationalElements for Pluto {
    const RIGHT_ASCENSION_COEFFICIENTS: RightAscensionCoefficients = RightAscensionCoefficients(
        PolynomialCoefficient(132.993f64),
        PolynomialCoefficient(0f64),
    );
}
#[cfg(test)]
