mod schema_oem {
    pub mod xml_schema_types {
        ...
        pub struct OemType {
            ...
            #[serde(rename = "body")]
            pub body: schema_common::xml_schema_types::OemBody,
            #[serde(rename = "@id")]
            pub id: String,
        ...
        pub struct OemBody {
            ...
            pub segment_list: Vec<schema_common::xml_schema_types::OemSegment>,
        }
        ...
        pub struct OemSegment {
            ...
            pub metadata: schema_common::xml_schema_types::OemMetadata,
            #[serde(rename = "data")]
            pub data: schema_common::xml_schema_types::OemData,
        }
        ...
        pub struct OemMetadata {
            ...
            pub start_time: schema_common::xml_schema_types::EpochType,
            ...
            pub stop_time: schema_common::xml_schema_types::EpochType,
        ...
        pub struct OemData {
            ...
            pub state_vector_list: Vec<schema_common::xml_schema_types::StateVectorAccType>,
            #[serde(rename = "covarianceMatrix")]
            pub covariance_matrix_list:
