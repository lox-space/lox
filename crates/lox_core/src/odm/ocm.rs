mod schema_ocm {
    pub mod xml_schema_types {
        ...
        pub struct OcmType {
            ...
            #[serde(rename = "body")]
            pub body: schema_common::xml_schema_types::OcmBody,
            #[serde(rename = "@id")]
            pub id: String,
        ...
        pub struct OcmBody {
            ...
            pub segment: schema_common::xml_schema_types::OcmSegment,
        }
        ...
        pub struct OcmSegment {
            ...
            pub metadata: schema_common::xml_schema_types::OcmMetadata,
            #[serde(rename = "data")]
            pub data: schema_common::xml_schema_types::OcmData,
        }
        ...
        pub struct OcmMetadata {
            ...
            pub object_type: Option<schema_common::xml_schema_types::ObjectDescriptionType>,
            #[serde(rename = "TIME_SYSTEM")]
            pub time_system: String,
            #[serde(rename = "EPOCH_TZERO")]
            pub epoch_tzero: schema_common::xml_schema_types::EpochType,
            ...
            pub sclk_offset_at_epoch: Option<schema_common::xml_schema_types::TimeOffsetType>,
            #[serde(rename = "SCLK_SEC_PER_SI_SEC")]
            pub sclk_sec_per_si_sec: Option<schema_common::xml_schema_types::DurationType>,
            #[serde(rename = "PREVIOUS_MESSAGE_EPOCH")]
            pub previous_message_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "NEXT_MESSAGE_EPOCH")]
            pub next_message_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "START_TIME")]
            pub start_time: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "STOP_TIME")]
            pub stop_time: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "TIME_SPAN")]
            pub time_span: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            #[serde(rename = "TAIMUTC_AT_TZERO")]
            pub taimutc_at_tzero: Option<schema_common::xml_schema_types::TimeOffsetType>,
            #[serde(rename = "NEXT_LEAP_EPOCH")]
            pub next_leap_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "NEXT_LEAP_TAIMUTC")]
            pub next_leap_taimutc: Option<schema_common::xml_schema_types::TimeOffsetType>,
            #[serde(rename = "UT1MUTC_AT_TZERO")]
            pub ut1mutc_at_tzero: Option<schema_common::xml_schema_types::TimeOffsetType>,
        ...
        pub struct OcmData {
            #[serde(rename = "traj")]
            pub traj_list: Vec<schema_common::xml_schema_types::OcmTrajStateType>,
            #[serde(rename = "phys")]
            pub phys: Option<schema_common::xml_schema_types::OcmPhysicalDescriptionType>,
            #[serde(rename = "cov")]
            pub cov_list: Vec<schema_common::xml_schema_types::OcmCovarianceMatrixType>,
            #[serde(rename = "man")]
            pub man_list: Vec<schema_common::xml_schema_types::OcmManeuverParametersType>,
            #[serde(rename = "pert")]
            pub pert: Option<schema_common::xml_schema_types::OcmPerturbationsType>,
            #[serde(rename = "od")]
            pub od: Option<schema_common::xml_schema_types::OcmOdParametersType>,
            #[serde(rename = "user")]
            pub user: Option<schema_common::xml_schema_types::UserDefinedType>,
        }
        ...
        pub struct OcmTrajStateType {
            ...
            pub traj_basis: Option<schema_common::xml_schema_types::TrajBasisType>,
            ...
            pub traj_frame_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "USEABLE_START_TIME")]
            pub useable_start_time: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "USEABLE_STOP_TIME")]
            pub useable_stop_time: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "ORB_REVNUM")]
            pub orb_revnum: Option<schema_common::xml_schema_types::NonNegativeDouble>,
            #[serde(rename = "ORB_REVNUM_BASIS")]
            pub orb_revnum_basis: Option<schema_common::xml_schema_types::RevNumBasisType>,
        ...
        pub struct OcmPhysicalDescriptionType {
            ...
            pub drag_const_area: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "DRAG_COEFF_NOM")]
            pub drag_coeff_nom: Option<schema_common::xml_schema_types::PositiveDouble>,
            #[serde(rename = "DRAG_UNCERTAINTY")]
            pub drag_uncertainty: Option<schema_common::xml_schema_types::PercentageType>,
            #[serde(rename = "INITIAL_WET_MASS")]
            pub initial_wet_mass: Option<schema_common::xml_schema_types::MassType>,
            #[serde(rename = "WET_MASS")]
            pub wet_mass: Option<schema_common::xml_schema_types::MassType>,
            #[serde(rename = "DRY_MASS")]
            pub dry_mass: Option<schema_common::xml_schema_types::MassType>,
            #[serde(rename = "OEB_PARENT_FRAME")]
            pub oeb_parent_frame: Option<String>,
            #[serde(rename = "OEB_PARENT_FRAME_EPOCH")]
            pub oeb_parent_frame_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "OEB_Q1")]
            ...
            pub oeb_max: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OEB_INT")]
            pub oeb_int: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OEB_MIN")]
            pub oeb_min: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "AREA_ALONG_OEB_MAX")]
            pub area_along_oeb_max: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "AREA_ALONG_OEB_INT")]
            pub area_along_oeb_int: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "AREA_ALONG_OEB_MIN")]
            pub area_along_oeb_min: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "AREA_MIN_FOR_PC")]
            pub area_min_for_pc: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "AREA_MAX_FOR_PC")]
            pub area_max_for_pc: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "AREA_TYP_FOR_PC")]
            pub area_typ_for_pc: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "RCS")]
            pub rcs: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "RCS_MIN")]
            pub rcs_min: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "RCS_MAX")]
            pub rcs_max: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "SRP_CONST_AREA")]
            pub srp_const_area: Option<schema_common::xml_schema_types::AreaType>,
            #[serde(rename = "SOLAR_RAD_COEFF")]
            pub solar_rad_coeff: Option<f64>,
            #[serde(rename = "SOLAR_RAD_UNCERTAINTY")]
            pub solar_rad_uncertainty: Option<schema_common::xml_schema_types::PercentageType>,
            ...
            pub reflectance: Option<schema_common::xml_schema_types::ProbabilityType>,
            ...
            pub att_knowledge: Option<schema_common::xml_schema_types::AngleType>,
            #[serde(rename = "ATT_CONTROL")]
            pub att_control: Option<schema_common::xml_schema_types::AngleType>,
            #[serde(rename = "ATT_POINTING")]
            pub att_pointing: Option<schema_common::xml_schema_types::AngleType>,
            #[serde(rename = "AVG_MANEUVER_FREQ")]
            pub avg_maneuver_freq: Option<schema_common::xml_schema_types::ManeuverFreqType>,
            #[serde(rename = "MAX_THRUST")]
            pub max_thrust: Option<schema_common::xml_schema_types::ThrustType>,
            #[serde(rename = "DV_BOL")]
            pub dv_bol: Option<schema_common::xml_schema_types::VelocityType>,
            #[serde(rename = "DV_REMAINING")]
            pub dv_remaining: Option<schema_common::xml_schema_types::VelocityType>,
            #[serde(rename = "IXX")]
            pub ixx: Option<schema_common::xml_schema_types::MomentType>,
            #[serde(rename = "IYY")]
            pub iyy: Option<schema_common::xml_schema_types::MomentType>,
            #[serde(rename = "IZZ")]
            pub izz: Option<schema_common::xml_schema_types::MomentType>,
            #[serde(rename = "IXY")]
            pub ixy: Option<schema_common::xml_schema_types::MomentType>,
            #[serde(rename = "IXZ")]
            pub ixz: Option<schema_common::xml_schema_types::MomentType>,
            #[serde(rename = "IYZ")]
            pub iyz: Option<schema_common::xml_schema_types::MomentType>,
        }
        ...
        pub struct OcmCovarianceMatrixType {
            ...
            pub cov_basis: Option<schema_common::xml_schema_types::CovBasisType>,
            ...
            pub cov_frame_epoch: Option<schema_common::xml_schema_types::EpochType>,
            ...
            pub cov_confidence: Option<schema_common::xml_schema_types::PercentageType>,
            #[serde(rename = "COV_TYPE")]
            pub cov_type: String,
            #[serde(rename = "COV_ORDERING")]
            pub cov_ordering: schema_common::xml_schema_types::CovOrderType,
        ...
        pub struct OcmManeuverParametersType {
            ...
            pub man_basis: Option<schema_common::xml_schema_types::ManBasisType>,
            ...
            pub man_prev_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "MAN_NEXT_EPOCH")]
            pub man_next_epoch: Option<schema_common::xml_schema_types::EpochType>,
            ...
            pub man_frame_epoch: Option<schema_common::xml_schema_types::EpochType>,
            ...
            pub dc_win_open: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "DC_WIN_CLOSE")]
            pub dc_win_close: Option<schema_common::xml_schema_types::EpochType>,
            ...
            pub dc_exec_start: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "DC_EXEC_STOP")]
            pub dc_exec_stop: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "DC_REF_TIME")]
            pub dc_ref_time: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "DC_TIME_PULSE_DURATION")]
            pub dc_time_pulse_duration: Option<schema_common::xml_schema_types::DurationType>,
            #[serde(rename = "DC_TIME_PULSE_PERIOD")]
            pub dc_time_pulse_period: Option<schema_common::xml_schema_types::DurationType>,
            #[serde(rename = "DC_REF_DIR")]
            pub dc_ref_dir: Option<schema_common::xml_schema_types::Vec3Double>,
            #[serde(rename = "DC_BODY_FRAME")]
            pub dc_body_frame: Option<String>,
            #[serde(rename = "DC_BODY_TRIGGER")]
            pub dc_body_trigger: Option<schema_common::xml_schema_types::Vec3Double>,
            #[serde(rename = "DC_PA_START_ANGLE")]
            pub dc_pa_start_angle: Option<schema_common::xml_schema_types::AngleType>,
            #[serde(rename = "DC_PA_STOP_ANGLE")]
            pub dc_pa_stop_angle: Option<schema_common::xml_schema_types::AngleType>,
        ...
        pub struct OcmPerturbationsType {
            ...
            pub equatorial_radius: Option<schema_common::xml_schema_types::PositionType>,
            #[serde(rename = "GM")]
            ...
            pub central_body_rotation: Option<schema_common::xml_schema_types::AngleRateType>,
            #[serde(rename = "OBLATE_FLATTENING")]
            pub oblate_flattening: Option<schema_common::xml_schema_types::PositiveDouble>,
            ...
            pub sw_data_epoch: Option<schema_common::xml_schema_types::EpochType>,
            #[serde(rename = "SW_INTERP_METHOD")]
            pub sw_interp_method: Option<String>,
            #[serde(rename = "FIXED_GEOMAG_KP")]
            pub fixed_geomag_kp: Option<schema_common::xml_schema_types::GeomagType>,
            #[serde(rename = "FIXED_GEOMAG_AP")]
            pub fixed_geomag_ap: Option<schema_common::xml_schema_types::GeomagType>,
            #[serde(rename = "FIXED_GEOMAG_DST")]
            pub fixed_geomag_dst: Option<schema_common::xml_schema_types::GeomagType>,
            #[serde(rename = "FIXED_F10P7")]
            pub fixed_f10p7: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_F10P7_MEAN")]
            pub fixed_f10p7_mean: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_M10P7")]
            pub fixed_m10p7: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_M10P7_MEAN")]
            pub fixed_m10p7_mean: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_S10P7")]
            pub fixed_s10p7: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_S10P7_MEAN")]
            pub fixed_s10p7_mean: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_Y10P7")]
            pub fixed_y10p7: Option<schema_common::xml_schema_types::SolarFluxType>,
            #[serde(rename = "FIXED_Y10P7_MEAN")]
            pub fixed_y10p7_mean: Option<schema_common::xml_schema_types::SolarFluxType>,
        }
        ...
        pub struct OcmOdParametersType {
            ...
            pub od_epoch: schema_common::xml_schema_types::EpochType,
            #[serde(rename = "DAYS_SINCE_FIRST_OBS")]
            pub days_since_first_obs: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            #[serde(rename = "DAYS_SINCE_LAST_OBS")]
            pub days_since_last_obs: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            #[serde(rename = "RECOMMENDED_OD_SPAN")]
            pub recommended_od_span: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            #[serde(rename = "ACTUAL_OD_SPAN")]
            pub actual_od_span: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            ...
            pub maximum_obs_gap: Option<schema_common::xml_schema_types::OcmDayIntervalType>,
            #[serde(rename = "OD_EPOCH_EIGMAJ")]
            pub od_epoch_eigmaj: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OD_EPOCH_EIGINT")]
            pub od_epoch_eigint: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OD_EPOCH_EIGMIN")]
            pub od_epoch_eigmin: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OD_MAX_PRED_EIGMAJ")]
            pub od_max_pred_eigmaj: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OD_MIN_PRED_EIGMIN")]
            pub od_min_pred_eigmin: Option<schema_common::xml_schema_types::OcmLengthType>,
            #[serde(rename = "OD_CONFIDENCE")]
            pub od_confidence: Option<schema_common::xml_schema_types::PercentageType>,
            #[serde(rename = "GDOP")]
            pub gdop: Option<schema_common::xml_schema_types::NonNegativeDouble>,
            ...
            #[serde(rename = "SEDR")]
            pub sedr: Option<schema_common::xml_schema_types::WkgType>,
            #[serde(rename = "SENSORS_N")]
            pub sensors_n: Option<u64>,
            #[serde(rename = "SENSORS")]
            pub sensors: Option<String>,
            #[serde(rename = "WEIGHTED_RMS")]
            pub weighted_rms: Option<schema_common::xml_schema_types::NonNegativeDouble>,
