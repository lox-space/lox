                ...
                OpmType {
                    header: OdmHeader {
                        ...
                        comment_list: vec![
                            ...
                            KvnValue {
                                value: "Current intermediate orbit IO2 and maneuver planning data".to_string(),
                                unit: None,
                            },
                        ],
                            ...
                            data: OpmData {
                                ...
                                spacecraft_parameters: Some(
                                    SpacecraftParametersType {
                                        comment_list: vec![
                                            KvnValue {
                                                value: "Spacecraft parameters".to_string(),
                                                unit: None,
                                            },
                                        ],
                                        mass: Some(
                                ...
                                maneuver_parameters_list: vec![
                                    ...
                                    ManeuverParametersType {
                                        comment_list: vec![
                                            KvnValue {
                                                value: "Second maneuver: first station acquisition maneuver".to_string(),
                                                unit: None,
                                            },
                                            KvnValue {
                                                value: "impulsive, thrust direction fixed in RTN frame".to_string(),
                                                unit: None,
                                            },
                                        ],
                                        man_epoch_ignition: KvnDateTimeValue {
