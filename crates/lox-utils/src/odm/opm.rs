mod schema_opm {
    pub mod xml_schema_types {
        ...
        pub struct OpmType {
            ...
            #[serde(rename = "body")]
            pub body: schema_common::xml_schema_types::OpmBody,
            #[serde(rename = "@id")]
            pub id: String,
        ...
        pub struct OpmBody {
            ...
            pub segment: schema_common::xml_schema_types::OpmSegment,
        }
        ...
        pub struct OpmSegment {
            ...
            pub metadata: schema_common::xml_schema_types::OpmMetadata,
            #[serde(rename = "data")]
            pub data: schema_common::xml_schema_types::OpmData,
        }
        ...
        pub struct OpmData {
            ...
            pub state_vector: schema_common::xml_schema_types::StateVectorType,
            #[serde(rename = "keplerianElements")]
            pub keplerian_elements: Option<schema_common::xml_schema_types::KeplerianElementsType>,
            ...
            pub maneuver_parameters_list:
                Vec<schema_common::xml_schema_types::ManeuverParametersType>,
        ...
        pub struct KeplerianElementsType {
            ...
            pub semi_major_axis: schema_common::xml_schema_types::DistanceType,
            ...
            #[serde(rename = "GM")]
            pub gm: schema_common::xml_schema_types::GmType,
        }
        ...
        pub struct ManeuverParametersType {
            ...
            pub man_epoch_ignition: schema_common::xml_schema_types::EpochType,
            #[serde(rename = "MAN_DURATION")]
            pub man_duration: schema_common::xml_schema_types::DurationType,
            #[serde(rename = "MAN_DELTA_MASS")]
            pub man_delta_mass: schema_common::xml_schema_types::DeltamassType,
            #[serde(rename = "MAN_REF_FRAME")]
            pub man_ref_frame: String,
            #[serde(rename = "MAN_DV_1")]
            pub man_dv_1: schema_common::xml_schema_types::VelocityType,
            #[serde(rename = "MAN_DV_2")]
            pub man_dv_2: schema_common::xml_schema_types::VelocityType,
            #[serde(rename = "MAN_DV_3")]
            pub man_dv_3: schema_common::xml_schema_types::VelocityType,
        }
    }
}
pub use schema_opm::*;
