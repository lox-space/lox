...
//! Module `continuous` provides a time representation which is generic over all astronomical time
//! scales without leap seconds.
//!
...
use crate::continuous::time_scales::TimeScale;
...
mod tests {
    ...
    use crate::continuous::time_scales::{TAI, TDB, TT};
