...
use lox_time::transformations::{NoOpOffsetProvider, TryToScale};
use pyo3::{PyErr, PyResult};
impl TryToFrame<PyTime, PyBody, Icrf, NoOpFrameTransformationProvider, PyErr> for PyState {
    fn try_to_frame(
        &self,
        frame: Icrf,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, Icrf>> {
        let state = self
            .0
            .with_time(self.0.time().try_to_scale(Tdb, &NoOpOffsetProvider)?);
        match self.0.reference_frame() {
            PyFrame::Icrf => Ok(self.0.with_frame(frame)),
            PyFrame::IauSun => Ok(state
                .with_frame(BodyFixed(Sun))
                .try_to_frame(frame, &NoOpFrameTransformationProvider)
                .unwrap()),
            PyFrame::IauMercury => todo!(),
            PyFrame::IauVenus => todo!(),
            PyFrame::IauEarth => todo!(),
            PyFrame::IauMars => todo!(),
            PyFrame::IauJupiter => todo!(),
            PyFrame::IauSaturn => todo!(),
            PyFrame::IauUranus => todo!(),
            PyFrame::IauNeptune => todo!(),
            PyFrame::IauPluto => todo!(),
            PyFrame::IauMoon => todo!(),
            PyFrame::IauPhobos => todo!(),
            PyFrame::IauDeimos => todo!(),
            PyFrame::IauIo => todo!(),
            PyFrame::IauEuropa => todo!(),
            PyFrame::IauGanymede => todo!(),
            PyFrame::IauCallisto => todo!(),
            PyFrame::IauAmalthea => todo!(),
            PyFrame::IauHimalia => todo!(),
            PyFrame::IauElara => todo!(),
            PyFrame::IauPasiphae => todo!(),
            PyFrame::IauSinope => todo!(),
            PyFrame::IauLysithea => todo!(),
            PyFrame::IauCarme => todo!(),
            PyFrame::IauAnanke => todo!(),
            PyFrame::IauLeda => todo!(),
            PyFrame::IauThebe => todo!(),
            PyFrame::IauAdrastea => todo!(),
            PyFrame::IauMetis => todo!(),
            PyFrame::IauCallirrhoe => todo!(),
            PyFrame::IauThemisto => todo!(),
            PyFrame::IauMagaclite => todo!(),
            PyFrame::IauTaygete => todo!(),
            PyFrame::IauChaldene => todo!(),
            PyFrame::IauHarpalyke => todo!(),
            PyFrame::IauKalyke => todo!(),
            PyFrame::IauIocaste => todo!(),
            PyFrame::IauErinome => todo!(),
            PyFrame::IauIsonoe => todo!(),
            PyFrame::IauPraxidike => todo!(),
            PyFrame::IauAutonoe => todo!(),
            PyFrame::IauThyone => todo!(),
            PyFrame::IauHermippe => todo!(),
            PyFrame::IauAitne => todo!(),
            PyFrame::IauEurydome => todo!(),
            PyFrame::IauEuanthe => todo!(),
            PyFrame::IauEuporie => todo!(),
            PyFrame::IauOrthosie => todo!(),
            PyFrame::IauSponde => todo!(),
            PyFrame::IauKale => todo!(),
            PyFrame::IauPasithee => todo!(),
            PyFrame::IauHegemone => todo!(),
            PyFrame::IauMneme => todo!(),
            PyFrame::IauAoede => todo!(),
            PyFrame::IauThelxinoe => todo!(),
            PyFrame::IauArche => todo!(),
            PyFrame::IauKallichore => todo!(),
            PyFrame::IauHelike => todo!(),
            PyFrame::IauCarpo => todo!(),
            PyFrame::IauEukelade => todo!(),
            PyFrame::IauCyllene => todo!(),
            PyFrame::IauKore => todo!(),
            PyFrame::IauHerse => todo!(),
            PyFrame::IauDia => todo!(),
            PyFrame::IauMimas => todo!(),
            PyFrame::IauEnceladus => todo!(),
            PyFrame::IauTethys => todo!(),
            PyFrame::IauDione => todo!(),
            PyFrame::IauRhea => todo!(),
            PyFrame::IauTitan => todo!(),
            PyFrame::IauHyperion => todo!(),
            PyFrame::IauIapetus => todo!(),
            PyFrame::IauPhoebe => todo!(),
            PyFrame::IauJanus => todo!(),
            PyFrame::IauEpimetheus => todo!(),
            PyFrame::IauHelene => todo!(),
            PyFrame::IauTelesto => todo!(),
            PyFrame::IauCalypso => todo!(),
            PyFrame::IauAtlas => todo!(),
            PyFrame::IauPrometheus => todo!(),
            PyFrame::IauPandora => todo!(),
            PyFrame::IauPan => todo!(),
            PyFrame::IauYmir => todo!(),
            PyFrame::IauPaaliaq => todo!(),
            PyFrame::IauTarvos => todo!(),
            PyFrame::IauIjiraq => todo!(),
            PyFrame::IauSuttungr => todo!(),
            PyFrame::IauKiviuq => todo!(),
            PyFrame::IauMundilfari => todo!(),
            PyFrame::IauAlbiorix => todo!(),
            PyFrame::IauSkathi => todo!(),
            PyFrame::IauErriapus => todo!(),
            PyFrame::IauSiarnaq => todo!(),
            PyFrame::IauThrymr => todo!(),
            PyFrame::IauNarvi => todo!(),
            PyFrame::IauMethone => todo!(),
            PyFrame::IauPallene => todo!(),
            PyFrame::IauPolydeuces => todo!(),
            PyFrame::IauDaphnis => todo!(),
            PyFrame::IauAegir => todo!(),
            PyFrame::IauBebhionn => todo!(),
            PyFrame::IauBergelmir => todo!(),
            PyFrame::IauBestla => todo!(),
            PyFrame::IauFarbauti => todo!(),
            PyFrame::IauFenrir => todo!(),
            PyFrame::IauFornjot => todo!(),
            PyFrame::IauHati => todo!(),
            PyFrame::IauHyrrokkin => todo!(),
            PyFrame::IauKari => todo!(),
            PyFrame::IauLoge => todo!(),
            PyFrame::IauSkoll => todo!(),
            PyFrame::IauSurtur => todo!(),
            PyFrame::IauAnthe => todo!(),
            PyFrame::IauJarnsaxa => todo!(),
            PyFrame::IauGreip => todo!(),
            PyFrame::IauTarqeq => todo!(),
            PyFrame::IauAegaeon => todo!(),
            PyFrame::IauAriel => todo!(),
            PyFrame::IauUmbriel => todo!(),
            PyFrame::IauTitania => todo!(),
            PyFrame::IauOberon => todo!(),
            PyFrame::IauMiranda => todo!(),
            PyFrame::IauCordelia => todo!(),
            PyFrame::IauOphelia => todo!(),
            PyFrame::IauBianca => todo!(),
            PyFrame::IauCressida => todo!(),
            PyFrame::IauDesdemona => todo!(),
            PyFrame::IauJuliet => todo!(),
            PyFrame::IauPortia => todo!(),
            PyFrame::IauRosalind => todo!(),
            PyFrame::IauBelinda => todo!(),
            PyFrame::IauPuck => todo!(),
            PyFrame::IauCaliban => todo!(),
            PyFrame::IauSycorax => todo!(),
            PyFrame::IauProspero => todo!(),
            PyFrame::IauSetebos => todo!(),
            PyFrame::IauStephano => todo!(),
            PyFrame::IauTrinculo => todo!(),
            PyFrame::IauFrancisco => todo!(),
            PyFrame::IauMargaret => todo!(),
            PyFrame::IauFerdinand => todo!(),
            PyFrame::IauPerdita => todo!(),
            PyFrame::IauMab => todo!(),
            PyFrame::IauCupid => todo!(),
            PyFrame::IauTriton => todo!(),
            PyFrame::IauNereid => todo!(),
            PyFrame::IauNaiad => todo!(),
            PyFrame::IauThalassa => todo!(),
            PyFrame::IauDespina => todo!(),
            PyFrame::IauGalatea => todo!(),
            PyFrame::IauLarissa => todo!(),
            PyFrame::IauProteus => todo!(),
            PyFrame::IauHalimede => todo!(),
            PyFrame::IauPsamathe => todo!(),
            PyFrame::IauSao => todo!(),
            PyFrame::IauLaomedeia => todo!(),
            PyFrame::IauNeso => todo!(),
            PyFrame::IauCharon => todo!(),
            PyFrame::IauNix => todo!(),
            PyFrame::IauHydra => todo!(),
            PyFrame::IauKerberos => todo!(),
            PyFrame::IauStyx => todo!(),
            PyFrame::IauGaspra => todo!(),
            PyFrame::IauIda => todo!(),
            PyFrame::IauDactyl => todo!(),
            PyFrame::IauCeres => todo!(),
            PyFrame::IauPallas => todo!(),
            PyFrame::IauVesta => todo!(),
            PyFrame::IauPsyche => todo!(),
            PyFrame::IauLutetia => todo!(),
            PyFrame::IauKleopatra => todo!(),
            PyFrame::IauEros => todo!(),
            PyFrame::IauDavida => todo!(),
            PyFrame::IauMathilde => todo!(),
            PyFrame::IauSteins => todo!(),
            PyFrame::IauBraille => todo!(),
            PyFrame::IauWilsonHarrington => todo!(),
            PyFrame::IauToutatis => todo!(),
            PyFrame::IauItokawa => todo!(),
            PyFrame::IauBennu => todo!(),
        }
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Sun>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Sun>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Sun>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mercury>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mercury>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Venus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Venus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Earth>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Earth>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mars>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mars>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Jupiter>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Jupiter>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Saturn>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Saturn>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Uranus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Uranus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Neptune>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Neptune>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pluto>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pluto>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Moon>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Moon>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Phobos>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Phobos>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Deimos>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Deimos>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Io>, NoOpFrameTransformationProvider, PyErr> for PyState {
    fn try_to_frame(
        &self,
        frame: BodyFixed<Io>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Io>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Europa>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Europa>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ganymede>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ganymede>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Callisto>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Callisto>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Amalthea>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Amalthea>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Himalia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Himalia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Elara>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Elara>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pasiphae>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pasiphae>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Sinope>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Sinope>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Lysithea>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Lysithea>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Carme>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Carme>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ananke>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ananke>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Leda>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Leda>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Thebe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Thebe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Adrastea>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Adrastea>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Metis>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Metis>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Callirrhoe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Callirrhoe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Themisto>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Themisto>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Magaclite>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Magaclite>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Taygete>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Taygete>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Chaldene>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Chaldene>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Harpalyke>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Harpalyke>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kalyke>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kalyke>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Iocaste>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Iocaste>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Erinome>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Erinome>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Isonoe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Isonoe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Praxidike>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Praxidike>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Autonoe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Autonoe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Thyone>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Thyone>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hermippe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hermippe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Aitne>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Aitne>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Eurydome>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Eurydome>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Euanthe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Euanthe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Euporie>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Euporie>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Orthosie>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Orthosie>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Sponde>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Sponde>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kale>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kale>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pasithee>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pasithee>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hegemone>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hegemone>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mneme>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mneme>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Aoede>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Aoede>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Thelxinoe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Thelxinoe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Arche>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Arche>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kallichore>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kallichore>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Helike>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Helike>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Carpo>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Carpo>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Eukelade>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Eukelade>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Cyllene>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Cyllene>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kore>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kore>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Herse>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Herse>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Dia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Dia>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Dia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mimas>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mimas>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Enceladus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Enceladus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Tethys>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Tethys>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Dione>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Dione>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Rhea>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Rhea>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Titan>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Titan>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hyperion>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hyperion>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Iapetus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Iapetus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Phoebe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Phoebe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Janus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Janus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Epimetheus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Epimetheus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Helene>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Helene>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Telesto>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Telesto>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Calypso>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Calypso>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Atlas>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Atlas>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Prometheus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Prometheus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pandora>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pandora>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pan>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Pan>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pan>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ymir>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ymir>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Paaliaq>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Paaliaq>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Tarvos>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Tarvos>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ijiraq>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ijiraq>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Suttungr>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Suttungr>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kiviuq>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kiviuq>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mundilfari>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mundilfari>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Albiorix>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Albiorix>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Skathi>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Skathi>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Erriapus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Erriapus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Siarnaq>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Siarnaq>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Thrymr>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Thrymr>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Narvi>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Narvi>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Methone>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Methone>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pallene>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pallene>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Polydeuces>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Polydeuces>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Daphnis>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Daphnis>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Aegir>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Aegir>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Bebhionn>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Bebhionn>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Bergelmir>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Bergelmir>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Bestla>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Bestla>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Farbauti>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Farbauti>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Fenrir>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Fenrir>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Fornjot>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Fornjot>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hati>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hati>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hyrrokkin>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hyrrokkin>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kari>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kari>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Loge>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Loge>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Skoll>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Skoll>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Surtur>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Surtur>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Anthe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Anthe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Jarnsaxa>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Jarnsaxa>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Greip>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Greip>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Tarqeq>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Tarqeq>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Aegaeon>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Aegaeon>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ariel>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ariel>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Umbriel>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Umbriel>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Titania>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Titania>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Oberon>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Oberon>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Miranda>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Miranda>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Cordelia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Cordelia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ophelia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ophelia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Bianca>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Bianca>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Cressida>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Cressida>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Desdemona>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Desdemona>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Juliet>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Juliet>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Portia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Portia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Rosalind>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Rosalind>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Belinda>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Belinda>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Puck>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Puck>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Caliban>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Caliban>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Sycorax>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Sycorax>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Prospero>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Prospero>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Setebos>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Setebos>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Stephano>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Stephano>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Trinculo>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Trinculo>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Francisco>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Francisco>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Margaret>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Margaret>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ferdinand>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ferdinand>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Perdita>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Perdita>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mab>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Mab>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mab>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Cupid>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Cupid>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Triton>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Triton>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Nereid>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Nereid>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Naiad>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Naiad>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Thalassa>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Thalassa>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Despina>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Despina>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Galatea>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Galatea>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Larissa>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Larissa>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Proteus>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Proteus>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Halimede>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Halimede>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Psamathe>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Psamathe>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Sao>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Sao>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Sao>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Laomedeia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Laomedeia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Neso>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Neso>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Charon>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Charon>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Nix>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Nix>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Nix>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Hydra>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Hydra>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kerberos>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kerberos>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Styx>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Styx>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Gaspra>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Gaspra>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ida>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        frame: BodyFixed<Ida>,
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ida>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Dactyl>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Dactyl>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Ceres>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Ceres>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Pallas>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Pallas>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Vesta>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Vesta>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Psyche>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Psyche>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Lutetia>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Lutetia>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Kleopatra>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Kleopatra>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Eros>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Eros>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Davida>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Davida>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Mathilde>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Mathilde>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Steins>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Steins>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Braille>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Braille>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<WilsonHarrington>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<WilsonHarrington>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Toutatis>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Toutatis>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Itokawa>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Itokawa>>> {
        todo!()
    }
}
impl TryToFrame<PyTime, PyBody, BodyFixed<Bennu>, NoOpFrameTransformationProvider, PyErr>
    for PyState
{
    fn try_to_frame(
        &self,
        ...
        _: &NoOpFrameTransformationProvider,
    ) -> PyResult<State<PyTime, PyBody, BodyFixed<Bennu>>> {
        todo!()
    }
}
