...
## [0.1.0-alpha.40](https://github.com/lox-space/lox/compare/lox-orbits-v0.1.0-alpha.39...lox-orbits-v0.1.0-alpha.40) - 2026-08-20
...
- *(lox-orbits)* fix broken intra-doc links

## [0.1.0-alpha.38](https://github.com/lox-space/lox/compare/lox-orbits-v0.1.0-alpha.37...lox-orbits-v0.1.0-alpha.38) - 2026-05-18
...
## [0.1.0-alpha.32](https://github.com/lox-space/lox/compare/lox-orbits-v0.1.0-alpha.31...lox-orbits-v0.1.0-alpha.32) - 2026-03-31
...
- fix lints in tests
- *(lox-orbits)* handle condition where epoch does not match interval/steps
...
- *(lox-orbits)* error when encountering invalid SSO

### Other

- *(lox-orbits)* deduplicate API
- *(lox-orbits)* split orbits.rs into submodules
- *(lox-orbits)* add missing features to new API
...
## [0.1.0-alpha.19](https://github.com/lox-space/lox/compare/lox-orbits-v0.1.0-alpha.18...lox-orbits-v0.1.0-alpha.19) - 2025-07-18

### Other

- updated the following local packages: lox-time, lox-frames, lox-earth
