...
describe('units', () => {
  ...
  it('distance from kilometers', () => {
    ...
    assert.equal(d.to_string_js(), '1024 km');
  ...
  it('distance from meters', () => {
    ...
    assert.equal(d.to_string_js(), '2.048 km');
  ...
  it('frequency from hertz', () => {
    ...
    assert.equal(f.to_string_js(), '1.073741824 GHz');
  ...
  it('frequency from kilohertz', () => {
    ...
    assert.equal(f.to_string_js(), '2 GHz');
  ...
  it('velocity from m/s', () => {
    ...
    assert.equal(v.to_string_js(), '262.144 km/s');
  ...
  it('velocity from km/s', () => {
    ...
    assert.equal(v.to_string_js(), '16 km/s');
