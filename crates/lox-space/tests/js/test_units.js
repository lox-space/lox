...
describe('units', () => {
  it('angle from radians', () => {
    ...
    assert.equal(a.debug(), 'Angle(3.141592653589793)');
  ...
  it('distance from kilometers', () => {
    ...
    assert.equal(d.debug(), 'Distance(1024000)');
  ...
  it('distance from meters', () => {
    ...
    assert.equal(d.debug(), 'Distance(2048)');
  ...
  it('frequency from hertz', () => {
    ...
    assert.equal(f.debug(), 'Frequency(1073741824)');
  ...
  it('frequency from kilohertz', () => {
    ...
    assert.equal(f.debug(), 'Frequency(2000000000)');
  ...
  it('velocity from m/s', () => {
    ...
    assert.equal(v.debug(), 'Velocity(262144)');
  ...
  it('velocity from km/s', () => {
    ...
    assert.equal(v.debug(), 'Velocity(16000)');
