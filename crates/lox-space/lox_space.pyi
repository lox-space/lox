...
class Time:
    ...
    @classmethod
    def from_julian_date(cls, scale: Scale | TimeScale, jd: float, epoch: str = "jd") -> Self: ...
    @classmethod
    ...
    @classmethod
    def from_seconds(cls, scale: Scale | TimeScale, seconds: int, subsecond: float) -> Self: ...
    ...
    def to_scale(self, scale: Scale | TimeScale, provider: UT1Provider | None = None) -> Self: ...
...
class UTC:
    ...
    def picosecond(self) -> int: ...
    def decimal_seconds(self) -> float: ...
    def to_scale(self, scale: Scale | TimeScale, provider: UT1Provider | None = None) -> Time: ...
